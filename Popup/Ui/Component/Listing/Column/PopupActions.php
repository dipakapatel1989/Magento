...
namespace Nakshatra\Popup\Ui\Component\Listing\Column;
...
{
    /** Url path */
    private const URL_PATH_EDIT = 'nakshatra_popup/popup/edit';
    private const URL_PATH_DELETE = 'nakshatra_popup/popup/delete';
