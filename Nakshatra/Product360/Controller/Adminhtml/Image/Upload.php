...
class Upload extends Action
{
    ...
    private Product360ImageRepositoryInterface $imageRepository;
    private Product360ImageFactory $imageFactory;
    ...
    public function __construct(
        ...
        Product360ImageRepositoryInterface $imageRepository,
        Product360ImageFactory $imageFactory
    ) {
